...
public class Questions implements Serializable {
    ...
    private boolean pushNotificaton;
    ...
    public boolean isPushNotificaton() {
        return pushNotificaton;
    }

    public void setPushNotificaton(boolean pushNotificaton) {
        this.pushNotificaton = pushNotificaton;
    }
